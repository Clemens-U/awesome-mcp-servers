...
- <img src="https://www.json-buddy.com/images-jsonbuddy/jsonbuddy_logo_128.png" height="14"/> [JSONBuddy MCP](https://www.json-buddy.com/core-api/mcp.json) – MCP server providing JSON validation, JSON Schema validation, and JSON Schema documentation generation via the JSONBuddy API.
